...
var btnDecrease = document.querySelector('#decrease'); // action 만들기 : 프로젝트의 상태에 변화를 일으키는 것
// 액션 이름 지정

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // 액션 이름을 사용하여 액션 객체를 만드는 함수 작성
...
var store = (0, _redux.createStore)(reducer); // HTML 엘리먼트에 접근하여 UI를 변경하는 함수
...
render(); // 스토어의 상태가 바뀔때마다 UI가 변경되도록, render함수를 실행시켜주는 subscribe 메서드

store.subscribe(render); // dispatch 메서드로 각 엘리먼트 클릭 시 인자로 넘긴 함수가 실행되도록 함
...
},{"redux":"node_modules/redux/es/redux.js"}],"../../../../.nvm/versions/node/v12.13.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../.nvm/versions/node/v12.13.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
